(function () {
  ...
  var translations = {
    en: {
      ...
      'consulting.exp2.body': 'Design and delivery of geoscience data products and the databases and applications behind them. Integration of geological, assay, and geoscience data so exploration and geology teams work from a single, queryable source of truth.',
      'consulting.exp3.title': 'Sensors, remote sensing, and machine learning',
      'consulting.exp3.body': 'Multimodal corescan and sensor workflows: RGB, hyperspectral, XRF, and magnetic susceptibility, collocated and governed for mineral-system interpretation. Remote-sensing and raster stacks (satellite and airborne imagery, geophysics, and seismic) can be integrated with geology and geochemistry for prospectivity mapping and targeting. Predictive geochemistry, computer-vision logging of core and chips, and machine-learning models that stay explainable, reproducible, and fit for exploration and resource decisions.',
    ...
    es: {
      ...
      'consulting.exp1.body': 'Modelamiento geológico, análisis exploratorio de datos, variografía, y estimación y simulación geoestadística de recursos minerales. Modelamiento categórico y de leyes en conjuntos de datos de múltiples yacimientos y múltiples campañas; cuantificación de incertidumbre; y clasificación alineada con CIM en apoyo de reportes NI 43-101, auditorías y due diligence. Experiencia más fuerte en oro y metales preciosos.',
      'consulting.exp2.title': 'Productos de datos geoientíficos y sistemas',
      'consulting.exp2.body': 'Diseño y entrega de productos de datos geoientíficos y de las bases de datos y aplicaciones que los sostienen. Integración de datos geológicos, de leyes y geocientíficos para que los equipos de exploración y geología trabajen desde una única fuente de verdad consultable.',
      'consulting.exp3.title': 'Sensores, teledetección y aprendizaje automático',
      'consulting.exp3.body': 'Flujos de trabajo multimodales de corescan y sensores: RGB, hiperespectral, XRF y susceptibilidad magnética, colocalizados y gobernados para la interpretación de sistemas minerales. Capas raster y de teledetección (imágenes satelitales y aerotransportadas, geofísica y sísmica) se pueden integrar con geología y geoquímica para mapeo de prospectividad y targeting. Geoquímica predictiva, registro de testigos y chips por visión computacional, y modelos de aprendizaje automático interpretables, reproducibles y aptos para decisiones de exploración y de recursos.',
