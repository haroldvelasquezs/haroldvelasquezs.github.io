(function () {
  ...
  var translations = {
    en: {
      ...
      'about.lead': 'Harold Velasquez Sanchez is a resource geologist and spatial data scientist with more than ten years leading mineral resource work in junior companies, large mining operations, and consulting. His work covers geological modeling, geostatistics, QA/QC, geoscience data products, data governance, prospectivity mapping, and targeting, including support to Qualified Persons on NI 43-101 updates, resource audits, and due diligence.',
      'about.education': 'He completed an MSc in Mining Engineering at the University of Alberta in January 2023 and was a graduate research assistant at the Centre for Computational Geostatistics (CCG). His undergraduate degree is Geological Engineering from the National University of Engineering, Peru (December 2015).',
      'about.credentials': 'Working languages: Spanish (native) and English.',
      'consulting.lead': 'Resource modeling, audits, and geoscience data products for exploration and mining teams, from interpretation through resource evaluation and ore control. The work is built for technical review and for day-to-day geology.',
      ...
      'consulting.exp2.body': 'Design and delivery of geoscience data products and the databases and applications behind them. Data governance for geological logging and geotechnical instrumentation so records stay controlled, traceable, and usable across teams.',
    ...
    es: {
      ...
      'about.lead': 'Harold Velasquez Sanchez es geólogo de recursos y científico de datos espaciales, con más de diez años liderando trabajo de recursos minerales en compañías junior, grandes operaciones mineras y consultoría. Su trabajo cubre modelamiento geológico, geoestadística, QA/QC, productos de datos geocientíficos, gobernanza de datos, mapeo de prospectividad y targeting, incluido el apoyo a Personas Calificadas en actualizaciones NI 43-101, auditorías de recursos y due diligence.',
      'about.education': 'Completó una maestría (MSc) en Ingeniería de Minas en la University of Alberta en enero de 2023 y fue asistente de investigación de posgrado en el Centre for Computational Geostatistics (CCG). Su título de pregrado es Ingeniería Geológica por la Universidad Nacional de Ingeniería, Perú (diciembre de 2015).',
      'about.credentials': 'Idiomas de trabajo: español (nativo) e inglés.',
      'consulting.lead': 'Modelado de recursos, auditorías y productos de datos geocientíficos para equipos de exploración y minería, desde la interpretación hasta la evaluación de recursos y el control de mineral. El trabajo está pensado para revisión técnica y para la geología del día a día.',
      ...
      'consulting.exp2.body': 'Diseño y entrega de productos de datos geoientíficos y de las bases de datos y aplicaciones que los sostienen. Gobernanza de datos para logging geológico e instrumentación geotécnica, de modo que los registros queden controlados, trazables y usables entre equipos.',
